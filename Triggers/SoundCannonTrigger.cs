    ...
    public class SoundCannonPatch
    {
        ...
        static void Prefix(string clip)
        {
            if (clip == "tinnitus")
            {
                ...
                {
                    new VibrationCheckPoint(0.0f, 1.0f, InterpolationType.Linear),
                    new VibrationCheckPoint(3f, 1f, InterpolationType.Smooth),
                    new VibrationCheckPoint(15f, 0.3f, InterpolationType.Linear)
                });
